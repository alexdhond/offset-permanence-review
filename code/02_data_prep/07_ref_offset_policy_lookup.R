# ================================================================
# Script:     07_ref_offset_policy_lookup.R
# Date:       2025-06-12
# Author:     Alex Dhond
...
if (nrow(unmapped_policies) > 0) {
  warning("WARNING: Some policy names were not standardized. See `unmapped_policies` and `unmapped_policy_counts`.")
...
if (nrow(policy_lookup_nas) > 0) {
  warning("WARNING: The policy lookup table has missing values. See `policy_lookup_nas` for details.")
...
write_csv(policy_lookup, here("data", "lookups", "offset_policy_lookup.csv"))
