...
data <- read_excel(here("data", "raw", "offset_perm_rev_database.xlsx")) %>%
  clean_names()
...
write_csv(continent_aliases, here("data", "lookups", "country", "continent_aliases.csv"))
write_csv(country_aliases, here("data", "lookups", "country", "country_aliases.csv"))
write_csv(region_aliases, here("data", "lookups", "country", "region_aliases.csv"))
...
write_csv(unmatched, here("data", "lookups", "country", "unmatched_country_region.csv"))
write_csv(validated, here("data", "lookups", "country", "validated_country_region_lookup.csv"))
